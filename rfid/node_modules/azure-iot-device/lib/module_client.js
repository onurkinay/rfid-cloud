...
var ModuleClient = /** @class */ (function (_super) {
    ...
    ModuleClient.prototype.invokeMethod = function (deviceId, moduleIdOrMethodParams, methodParamsOrCallback, callback) {
        ...
        return azure_iot_common_1.callbackToPromise(function (_callback) { return _this._invokeMethod(deviceId, methodParamsOrCallback, methodParamsOrCallback, _callback); });
    };
    /**
