...
export declare class ModuleClient extends InternalClient {
    ...
    private _disableInputMessages(callback);
    private _enableInputMessages(callback);
    /**
    ...
    private static _fromEnvironmentEdge(transportCtor, callback);
    private static _fromEnvironmentNormal(connectionString, transportCtor, callback);
